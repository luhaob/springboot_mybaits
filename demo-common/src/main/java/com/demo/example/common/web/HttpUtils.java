package com.demo.example.common.web;


import com.demo.example.common.exception.DemoHttpException;
...
public class HttpUtils {
    ...
    public String postJson(final String url, final String param, final Map<String, String> headerParam) throws IOException {
        long startTime = System.currentTimeMillis();
        HttpPost httpPost = new HttpPost(url);
        if (param != null) {
            httpPost.setEntity(new StringEntity(param, "utf-8"));
    ...
    public String request(final HttpRequestBase httpRequest) throws IOException {
        ...
        try {
            ...
            if (statusCode / 100 == 2) {
                ...
                throw new DemoHttpException("接口调用失败！url:" + httpRequest.getURI().toString()
